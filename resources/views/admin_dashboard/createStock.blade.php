    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="staticBackdropLabel">Upload product log file</h5>
        ...
        <div class="modal-body">
            <div class="form-group py-3">
                <label for="one">Upload file</label> <br>
                <input type="file" class="form-control-file" id="one">
            </div>
            <div class="form-group py-3">
